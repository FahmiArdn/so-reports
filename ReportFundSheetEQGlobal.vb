...
#End Region
    ...
    Private Sub ReportFundSheetEQGlobal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GetInstrumentUser()
        GetParameterCountry()
    ...
    Private Sub DisplayHolding()
        If dtSecurities IsNot Nothing AndAlso dtSecurities.Rows.Count > 0 AndAlso
           ...
           dtParameterInstrumentType IsNot Nothing AndAlso dtParameterInstrumentType.Rows.Count > 0 Then
           ...
           dtSector IsNot Nothing AndAlso dtSector.Rows.Count > 0 Then
            ...
            If query2.Count > 0 Then 'chart property
                ...
                For Each item In query2.Take(max)
                    ...
                    If item.Country.Length > 15 Then
                        series.Label = item.Country.Substring(0, 15).ToLowerInvariant & " "
                    Else
                        series.Label = item.Country.ToLowerInvariant & " "
                    End If
...
#Region "export"
    ...
    Private Sub ReportSetting()
        'Dim frm As New ReportFundSheetEQGlobalSetting
        'frm.frm = Me
        'frm.Show()
        'frm.FormLoad()
        'frm.MdiParent = MDISO
